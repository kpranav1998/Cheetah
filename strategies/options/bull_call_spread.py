...
class BullCallSpreadStrategy(BaseOptionsStrategy):
    """Buy ATM call, sell OTM call. Directional bullish with limited risk."""
    ...
    def select_strikes(self, underlying_price, options_chain, params) -> list[OptionsLeg]:
        ...
        return [
            OptionsLeg(option_type="CE", strike=long_strike, expiry=expiry, action="BUY"),
            OptionsLeg(option_type="CE", strike=short_strike, expiry=expiry, action="SELL"),
        ]
